...
class NavigationHostFragment : Fragment() {
    ...
    data class Arguments(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (navHostId != other.navHostId) return false
            if (tabItemId != other.tabItemId) return false
            if (!rootDests.contentEquals(other.rootDests)) return false

            return true
        }

        override fun hashCode(): Int {
            var result = layoutRes
            result = 31 * result + toolbarId
            result = 31 * result + navHostId
            result = 31 * result + tabItemId
            result = 31 * result + rootDests.contentHashCode()
            return result
        }
    }
